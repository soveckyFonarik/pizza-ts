...
export const Cart = (): React.ReactElement => {
  ...
  const CartiItemBlocks = pizzasCart.map((obj: any) => (
    <CartItemPizza key={obj.id + '_' + obj.size + '_' + obj.type} {...obj} />
  ));
        ...
        <div className="content__items">
          ...
          <div className="cart__bottom">
            <div className="cart__bottom-details">
              <span>
                Всего пицц:
                <b>{pizzasCart.reduce((partialSum, a) => partialSum + a.count, 0)} шт.</b>
              </span>
              <span>
                Сумма заказа:
                <b>{pizzasCart.reduce((partialSum, a) => partialSum + a.price, 0)} ₽</b>
              </span>
            </div>
